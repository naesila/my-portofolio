    ...
    <footer className="bg-[#1f1f1f] text-white py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-8 lg:px-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          {/* Logo & Description */}
          <div>
            <div className="flex gap-1 items-start text-[24px] mb-4">
              <span className="font-['Iosevka_Charon:Medium',sans-serif] text-white tracking-[-4px]">
                Information
              </span>
              <span className="font-semibold text-[#fc3314]">System</span>
            </div>
            <p className="text-gray-400 text-[13px] sm:text-[14px]">
              Creating meaningful digital solutions through technology and data.
            </p>
          </div>

          {/* Quick Links */}
          <div>
            <h3 className="font-bold text-[16px] sm:text-[18px] mb-4">Quick Links</h3>
            <ul className="space-y-2 text-[13px] sm:text-[14px]">
              <li>
                <a href="#about" className="text-gray-400 hover:text-[#fc3314] transition-colors">
                  About
                </a>
              </li>
              <li>
                <a href="#skills" className="text-gray-400 hover:text-[#fc3314] transition-colors">
                  Services
                </a>
              </li>
              <li>
                <a href="#portfolio" className="text-gray-400 hover:text-[#fc3314] transition-colors">
                  Portfolio
                </a>
              </li>
              <li>
                <a href="#contact" className="text-gray-400 hover:text-[#fc3314] transition-colors">
                  Contact
                </a>
              </li>
            </ul>
          ...
          {/* Social Media */}
          <div>
            <h3 className="font-bold text-[16px] sm:text-[18px] mb-4">Follow Me</h3>
            <div className="flex gap-4">
              <a 
                href="#" 
                className="w-10 h-10 bg-white/10 rounded-full flex items-center justify-center hover:bg-[#fc3314] transition-colors"
                aria-label="Twitter"
              >
              ...
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M13.125 12.5H11.25V15H13.125V22.5H16.25V15H18.5L18.75 12.5H16.25V11.4375C16.25 10.875 16.375 10.625 16.9375 10.625H18.75V7.5H16.375C14.125 7.5 13.125 8.5 13.125 10.375V12.5Z" />
                </svg>
              </a>
            </div>
          </div>
        ...
        <div className="pt-8 border-t border-gray-800 text-center">
          <p className="text-gray-400 text-[13px] sm:text-[14px]">
            © {currentYear} Naesila Islamia. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
